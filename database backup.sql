...
insert  into `chat_messages`(`id`,`thread_id`,`sender_user_id`,`message`,`attachment_url`,`sent_at`,`is_seen`) values (1,1,7,'hello',NULL,'2026-03-31 17:40:31',1),(2,1,7,'hello',NULL,'2026-04-01 01:55:54',1),(3,1,7,'hi',NULL,'2026-04-01 01:55:57',1),(4,1,31,'hello',NULL,'2026-04-01 07:22:05',1),(5,1,7,'ay hala. hello',NULL,'2026-04-01 07:24:55',1),(6,1,31,'test',NULL,'2026-04-01 07:42:46',1),(7,1,31,'hello po',NULL,'2026-04-06 08:44:02',1),(8,1,7,'hala hello',NULL,'2026-04-06 08:44:26',1),(9,1,7,'hello',NULL,'2026-04-08 01:46:29',1),(10,1,31,'hello',NULL,'2026-04-08 01:46:39',1),(11,1,7,'hi',NULL,'2026-04-08 01:46:47',1),(12,1,7,'hello',NULL,'2026-04-08 01:50:46',1),(13,1,7,'hello',NULL,'2026-04-08 01:50:58',1),(14,1,31,'hello',NULL,'2026-04-08 01:51:03',1),(15,1,31,'hello',NULL,'2026-04-08 01:59:13',1),(16,1,7,'dadad',NULL,'2026-04-08 01:59:24',1),(17,1,7,'hello',NULL,'2026-04-08 01:59:42',1),(18,1,31,'dada',NULL,'2026-04-08 02:01:26',1),(19,1,7,'dad',NULL,'2026-04-08 02:03:11',1),(20,1,7,'dad',NULL,'2026-04-08 02:04:27',1),(21,1,31,'hi',NULL,'2026-04-08 02:11:27',1),(22,1,31,'hi',NULL,'2026-04-08 02:11:44',1),(23,1,31,'dada',NULL,'2026-04-08 02:11:50',1),(24,1,7,'dada',NULL,'2026-04-08 02:11:55',1),(25,1,7,'had',NULL,'2026-04-08 02:14:51',1),(26,1,7,'had',NULL,'2026-04-08 02:15:19',1),(27,1,31,'dad',NULL,'2026-04-08 02:15:26',1),(28,1,7,'had',NULL,'2026-04-08 02:16:04',1),(29,1,31,'dada',NULL,'2026-04-08 02:19:29',1),(30,1,31,'have',NULL,'2026-04-08 02:19:40',1),(31,1,31,'ayun',NULL,'2026-04-08 02:19:44',1),(32,1,7,'ptucah',NULL,'2026-04-08 02:19:50',1),(33,3,7,'dsadsa',NULL,'2026-04-12 02:29:38',0),(34,2,7,'hello',NULL,'2026-04-12 02:34:14',0),(35,1,7,'testing',NULL,'2026-04-12 09:10:56',0);
...
insert  into `chat_participants`(`thread_id`,`user_id`) values (1,7),(1,31),(2,7),(2,8),(2,10),(3,7),(3,8),(4,7),(4,8),(4,10),(4,11);
...
insert  into `chat_threads`(`id`,`type`,`name`,`class_id`,`created_at`) values (1,'class',NULL,1,'2026-03-31 17:39:34'),(2,'class',NULL,NULL,'0000-00-00 00:00:00'),(3,'private',NULL,NULL,'0000-00-00 00:00:00'),(4,'parent-staff','test',NULL,'0000-00-00 00:00:00');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `parentviews` AS select `p`.`id` AS `id`,concat(`u`.`fname`,' ',`u`.`lname`) AS `name`,`u`.`mobile` AS `mobile`,`u`.`status` AS `status`,`u`.`email` AS `email`,`p`.`id_verified_flag` AS `id_verified_flag`,`p`.`user_id` AS `user_id`,count(`s`.`primary_parent_id`) AS `children_count` from ((`parents` `p` join `users` `u` on(`p`.`user_id` = `u`.`id`)) join `students` `s` on(`s`.`primary_parent_id` = `p`.`user_id`)) group by `p`.`id` */;
