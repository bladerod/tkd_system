                        ...
                        <div class="" style="border-top: 1px solid rgba(0, 0, 0, 0.1);">
                            <form method="GET" action="{{ route('parents.index') }}" class="p-4 mx-4 mt-4 ">
                                ...
                                <div class="grid grid-cols-12 gap-4 items-end">
                                    ...
                                    <div class="col-span-3">
                                        <label
                                            class="block text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">ID
                                            Verification</label>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse ($parentList as $parent)
                                            <tr class="hover:bg-gray-50 transition-colors duration-150"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        class="badge badge-info px-2 py-1 text-xs font-semibold text-blue-700 bg-blue-100 rounded-full">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        class="text-sm {{ $parent['total_balance'] > 0 ? 'text-red-600 font-semibold' : 'text-green-600' }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    @if($parent['id_verified_flag'])
                                                        <span
                                                            class="px-2 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full"><i
                                                                class="fas fa-check"></i> Verified</span>
                                                    @else
                                                        <span
                                                            class="px-2 py-1 text-xs font-semibold text-yellow-700 bg-yellow-100 rounded-full"><i
                                                                class="fas fa-clock"></i> Pending</span>
                                                    @endif
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <button
                                                        class="text-white bg-blue-500 hover:bg-blue-600 p-2.5 rounded-lg"
                                                        onclick="openModal({{ $parent['user_id'] }})">
                                            ...
                                            <tr>
                                                <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                                                    <div class="flex flex-col items-center">
                                                        ...
                                                        <p class="text-sm">Click the "Add Parent" button to create a new
                                                            parent.</p>
                                                    </div>
                                                </td>
                                            </tr>
