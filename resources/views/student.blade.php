...
<body class="bg-gray-50">
    ...
    <div class="main-content px-6 py-6 mt-7">
        ...
        <div class="content-card mb-6">
            ...
            <form method="GET" action="{{ route('student') }}" class="mb-4 mx-4 mt-4">
                ...
                <div class="grid grid-cols-12 gap-4 items-end mb-4">
                    <div class="col-span-2">
                        <label
                            class="block text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">Status</label>
                        <select name="status"
                    ...
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">Belt
                            Level</label>
                        <select name="belt"
                            class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1C1C1D] focus:border-transparent transition-all duration-200 bg-white">
                    ...
                    <div class="col-span-3">
                        <label class="block text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">Enrolled
                            Date From</label>
                    ...
                    <div class="col-span-12">
                        <label class="block text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">Quick
                            Search</label>
                        <div class="flex gap-2">
                            <input type="text" id="jqSearchInput" value="{{ request('search') }}"
                                placeholder="Search student name..."
                                class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1C1C1D] focus:border-transparent transition-all duration-200 bg-white">
                            <button type="button" style=" display: none;" id="jqSearchBtn"
                    ...
                    <table id="studentTable" class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th onclick="sortTable('branch_name')">Branch </th>
                        ...
                        <tbody>
                            @foreach ($vwstudents as $student)
                                <tr>
                                    ...
                                    <td>{{ $student->branch_name ?? 'NO Branch' }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="{{ $student->balance > 0 ? 'text-red-600 font-semibold' : 'text-green-600' }}">
                                    ...
                                    <td>
                                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm"
                                            onclick="openModal(this)" data-id="{{ $student->id }}"
                                            data-name="{{ $student->student_name }}"
                                            data-belt="{{ $student->current_belt }}" data-status="{{ $student->status }}">
                                            View
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <table class="attendance-table min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-xs font-medium text-gray uppercase text-center">Check In
                                    </th>
                                    <th class="px-4 py-2 text-xs font-medium text-gray uppercase text-center">Check Out
                                    </th>
                                    <th class="px-4 py-2 text-xs font-medium text-gray uppercase text-center">Status
                                    </th>
                                    <th class="px-4 py-2 text-xs font-medium text-gray uppercase text-center">Method
                                    </th>
                                </tr>
                            </thead>
