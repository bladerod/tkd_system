                        ...
                        <tbody>
                            @foreach ($vwstudents as $student)
                                <tr>
                                    <td>
                                        <div>
                                            <p>{{ $student->student_name ?? 'NO NAME' }}</p>
                                            <p>{{ $student->student_code ?? 'NO NAME' }}</p>
                                        </div>
    ...
    <div id="studentModal" class="modal hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50">
        <div class="modal-content bg-white rounded-lg p-6 w-3/4 max-w-3xl relative">
            ...
            <div class="tabs flex gap-2 mb-4 border-b">
                <button class="tab active px-4 py-2 border-b-2 border-blue-600 font-medium" data-tab="profile"
                    onclick="switchTab(this)">Profile</button>
                <button class="tab px-4 py-2 text-gray-500 hover:text-gray-700 font-medium" data-tab="attendance"
                    onclick="switchTab(this)">Attendance</button>
                <button class="tab px-4 py-2 text-gray-500 hover:text-gray-700 font-medium" data-tab="billing"
                    onclick="switchTab(this)">Billing</button>
                <button class="tab px-4 py-2 text-gray-500 hover:text-gray-700 font-medium" data-tab="competition"
                    onclick="switchTab(this)">Competition</button>
                <button class="tab px-4 py-2 text-gray-500 hover:text-gray-700 font-medium" data-tab="certificates"
                    onclick="switchTab(this)">Certificates</button>
            </div>
            ...
            <div id="attendanceTab" class="tab-content hidden">
                ...
                <div id="noAttendanceData" class="text-gray-500 text-center py-4 hidden">No attendance records found.
                </div>
            </div>
